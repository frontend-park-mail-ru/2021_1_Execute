...
export default class LoginController {
  ...
  constructor(router, root) {
    ...
    this.eventBus.subscribe(LoginEvents.profile, () => router.go(ConstantEvents.profile));
    this.eventBus.subscribe(LoginEvents.registration, () => router.go(ConstantEvents.registration));
